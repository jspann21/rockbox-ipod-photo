...
This installs the committed `c336e188cb` Rockbox build. The Rockbox bootloader
must already be installed on the iPod.
...
Expand-Archive -LiteralPath ".\dist\rockbox-ipodcolor-c336e188cb.zip" -DestinationPath $destination -Force
...
```powershell
Expand-Archive -LiteralPath ".\dist\rockbox-ipodcolor-c336e188cb.zip" -DestinationPath "F:\" -Force
```
...
The firmware should report version `c336e188cb-260823`.
